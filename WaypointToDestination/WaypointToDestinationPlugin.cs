namespace WaypointToDestination;
...
[UsedImplicitly]
public sealed class WaypointToDestinationPlugin : SingletonPluginBase<WaypointToDestinationPlugin>, IModTabHandler
{
    ...
    private readonly ILogger _Logger = Log.ForContext<WaypointToDestinationPlugin>()!;

    public WaypointToDestinationPlugin(IModdingContext context, IUIHelper uiHelper)
    {
        Context = context;
        UiHelper = uiHelper;
